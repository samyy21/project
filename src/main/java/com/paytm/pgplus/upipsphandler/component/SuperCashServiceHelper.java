...
import com.paytm.pgplus.upipsphandler.constants.SupercashResponseConstants;
import com.paytm.pgplus.upipsphandler.enums.OrderSource;
import com.paytm.pgplus.upipsphandler.enums.PIIPayModes;
import com.paytm.pgplus.upipsphandler.exception.BaseException;
import com.paytm.pgplus.upipsphandler.exception.SupercashException;
import com.paytm.pgplus.upipsphandler.exception.SupercashException.*;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.MerchantExtendedInfo.MerchantExtendInfoKeys.ON_PAYTM;
...
public class SuperCashServiceHelper {
    ...
    public void validateRequest(SuperCashOfferRequest superCashOfferRequest, boolean offlineFlows)
        ...
        if (superCashOfferRequest == null || superCashOfferRequest.getBody() == null
            ...
            throw new SupercashException.SupercashIllegalParamException(SupercashResponseConstants.ILLEGAL_PARAMS.getMessage());
        }
    ...
    public String getWalletBalance(NativeCashierInfoResponse nativeCashierInfoResponse)
        ...
        for (PayMethod payMethod : nativeCashierInfoResponse
                .getBody().getMerchantPayOption().getPayMethods()) {
            if (com.paytm.pgplus.enums.PayMethod.BALANCE.getMethod().equals(payMethod.getPayMethod())) {
