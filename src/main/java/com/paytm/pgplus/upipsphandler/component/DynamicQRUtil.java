...
import com.paytm.pgplus.upipsphandler.exception.PaymentRequestQrException;
import com.paytm.pgplus.upipsphandler.model.WorkFlowTransactionBean;
...
public class DynamicQRUtil {
    ...
    public String getTransId(PaymentRequestBean requestData, com.paytm.pgplus.biz.workflow.model.WorkFlowRequestBean workFlowRequestBean) {
    ...
    private void setSubWalletAmountToWorkFlowBean(com.paytm.pgplus.biz.workflow.model.WorkFlowRequestBean workFlowRequestBean,
