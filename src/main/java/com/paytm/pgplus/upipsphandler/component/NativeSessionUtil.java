...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RedisKeysConstant.MASKED_CARD_NO;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RedisKeysConstant.MID_ORDER_TXN_TOKEN_WORKFLOW;
...
//    }
    ...
    public InitiateTransactionRequestBody getOrderDetail(String token) {
        com.paytm.pgplus.upipsphandler.model.NativeInitiateRequest nativeInitiateRequest = (com.paytm.pgplus.upipsphandler.model.NativeInitiateRequest) fetchField(token, "orderDetail");
        if (nativeInitiateRequest == null || nativeInitiateRequest.getInitiateTxnReq() == null) {
            throw SessionExpiredException.getException();
        } else {
...
//    public com.paytm.pgplus.request.InitiateTransactionRequestBody getOrderDetail(String token) {
