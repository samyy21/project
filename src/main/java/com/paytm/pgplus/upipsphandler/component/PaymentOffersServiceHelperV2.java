...
import com.paytm.pgplus.models.PromoCartOfferDetail;
import com.paytm.pgplus.models.PromoItemDetail;
...
import com.paytm.pgplus.upipsphandler.enums.PaymentPromoServiceError;
...
import com.paytm.pgplus.upipsphandler.service.CoftTokenDataService;
import com.paytm.pgplus.upipsphandler.service.IRequestProcessor;
import com.paytm.pgplus.upipsphandler.service.impl.AccessTokenUtils;
import com.paytm.pgplus.upipsphandler.service.impl.RequestProcessorFactory;
//import com.paytm.pgplus.upipsphandler.service.impl.WorkFlowHelper;
import com.paytm.pgplus.upipsphandler.utils.ConfigurationUtil;
import com.paytm.pgplus.upipsphandler.utils.PaymentOfferUtils;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtraConstants.CACHE_SEARCH_PAYMENT_OFFERS_RESPONSE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.FF4J.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.Ff4jFeature.ENABLE_GCIN_ON_COFT_PROMO;
...
//    }
    ...
    public boolean isDealsFlow(Map<String, String> affordabilityInfo) {
        return MapUtils.isNotEmpty(affordabilityInfo)
                && TheiaConstant.RequestParams.Native.DEAL_FLOW
                .equals(affordabilityInfo
                        .get(TheiaConstant.RequestParams.Native.PAYMENT_FLOW));
    }
    ...
    public ApplyPromoResponse prepareResponse(PromoServiceResponseBase baseResponse, ApplyPromoRequest request,
        ...
        if (isPromoServiceSuccessResponse(serviceResponse)) {
            if (serviceResponse.getData() != null) {
                if (TheiaConstant.RequestHeaders.Version_V2.equalsIgnoreCase(version)) {
...
//    }
    ...
    public String getWalletBalance(NativeCashierInfoResponse nativeCashierInfoResponse) {
        for (com.paytm.pgplus.upipsphandler.model.PayMethod payMethod : nativeCashierInfoResponse
...
//                TheiaConstant.RequestParams.Native.ORDER_ID))
