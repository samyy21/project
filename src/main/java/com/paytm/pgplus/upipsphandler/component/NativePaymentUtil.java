...
import com.paytm.pgplus.upipsphandler.model.common.FrontEndMsgConstant;
import com.paytm.pgplus.upipsphandler.service.impl.NativeFetchBalanceInfoRequestProcessor;
import com.paytm.pgplus.upipsphandler.service.impl.NativeFetchPcfDetailsRequestProcessor;
...
import com.paytm.pgplus.upipsphandler.utils.common.OfflinePaymentUtils;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RedisKeysConstant.NativeSession.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.Native.CARD_PRE_AUTH_TYPE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.SSO_TOKEN;
...
//
    ...
    public static com.paytm.pgplus.response.ResultInfo resultInfo(ResultCode resultCode) {
        if (resultCode == null)
            resultCode = ResultCode.UNKNOWN_ERROR;
        return new com.paytm.pgplus.response.ResultInfo(resultCode.getResultStatus(), resultCode.getResultCodeId(), resultCode.getResultMsg());
    }

    public static com.paytm.pgplus.response.ResultInfo resultInfoForSuccess() {
    ...
    public void fetchPaymentOptions(TokenRequestHeader request, InitiateTransactionRequestBody orderDetail,
        ...
        HttpServletRequest httpServletRequest = (javax.servlet.http.HttpServletRequest)
...
//
    public NativeCashierInfoResponse fetchPaymentOptionsForGuest(TokenRequestHeader request, String mid,
        ...
        HttpServletRequest httpServletRequest = (javax.servlet.http.HttpServletRequest)((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
                .getRequest();
        String preAuthType = (String) httpServletRequest.getAttribute(CARD_PRE_AUTH_TYPE);
        if (Objects.nonNull(preAuthType)) {
...
//    public static com.paytm.pgplus.response.ResultInfo resultInfoForFailure() {
...
//    public void logNativeResponse(final com.paytm.pgplus.response.ResultInfo resultInfo) {
//        try {
//            String mid = MDC.get("MID") != null ? MDC.get("MID") : "";
//            String orderId = MDC.get("ORDER_ID") != null ? MDC.get("ORDER_ID") : "";
...
//    }
//
//    public void logNativeResponse(final com.paytm.pgplus.response.ResultInfo resultInfo, String api) {
//        try {
//            String mid = MDC.get("MID") != null ? MDC.get("MID") : "";
//            String orderId = MDC.get("ORDER_ID") != null ? MDC.get("ORDER_ID") : "";
...
//    }
    ...
    public com.paytm.pgplus.response.ResultInfo getResultInfo(BaseResponseBody baseResponseBody) {
        return baseResponseBody == null ? null : baseResponseBody.getResultInfo();
    }

    public com.paytm.pgplus.response.ResultInfo getResultInfo(ResponseBody responseBody) {
        com.paytm.pgplus.response.ResultInfo resultInfo = null;
