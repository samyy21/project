...
import com.paytm.pgplus.upipsphandler.model.marker.EmiChannelMarker;
...
public class SavedCard extends CreditCard {
    ...
    @JsonIgnore
    private EmiChannelMarker emiDetails;
    ...
    public EmiChannelMarker getEmiDetails() {
        return emiDetails;
    }

    public void setEmiDetails(EmiChannelMarker emiDetails) {
