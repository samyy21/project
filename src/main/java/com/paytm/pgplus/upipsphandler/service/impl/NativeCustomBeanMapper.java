...
import com.paytm.pgplus.upipsphandler.enums.PaymentBankAccountStatus;
import com.paytm.pgplus.upipsphandler.model.*;
import com.paytm.pgplus.upipsphandler.model.EmiChannel;
...
import com.paytm.pgplus.upipsphandler.component.PaymentOffersServiceHelper;
import com.paytm.pgplus.upipsphandler.component.PrepaidCardValidationUtil;
...
import com.paytm.pgplus.upipsphandler.model.common.BankMandate;
import com.paytm.pgplus.upipsphandler.model.common.PayOption;
import com.paytm.pgplus.upipsphandler.model.common.SavedMandateBank;
import com.paytm.pgplus.upipsphandler.service.*;
import com.paytm.pgplus.upipsphandler.service.helper.EmiUtil;
import com.paytm.pgplus.upipsphandler.service.helper.HybridDisablingUtil;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.DEFAULT_INVESTMENT_FUNDING_TNC_URL;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.INVESTMENT_AS_FUNDING_SOURCE_TNC_URL;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.Native.CHECKOUT;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ResponseConstants.E_MANDATE;
...
public class NativeCustomBeanMapper implements ICustomBeanMapper<NativeCashierInfoResponse> {
    ...
    private AccountInfo getPPBLAccountInfo(FetchAccountBalanceResponse accountBalanceResponse) {
        ...
        accountInfo.setInvestmentTnCUrl(ConfigurationUtil.getProperty(
        ...
        if (accountInfo != null) {
            ...
            if (StringUtils
                ...
                if (StringUtils.isBlank(checkBalanceResponse.getInfoButtonMessage())) {
                    accountInfo
                            .setInfoButtonMessage(ConfigurationUtil
                                    .getProperty(
