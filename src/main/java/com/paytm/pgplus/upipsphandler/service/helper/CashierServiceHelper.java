...
import com.paytm.pgplus.upipsphandler.component.VPAHelper;
...
import com.paytm.pgplus.upipsphandler.model.BalanceChannel;
...
import com.paytm.pgplus.upipsphandler.service.impl.MerchantDataUtil;
...
//    }
    ...
    public void filterUpiPayOptionsInNative(
        ...
        if (upiPayMethod != null) {
            // Hack to remove UPI_PUSH_EXPRESS as a separate pay channel if
            // configured
            for (PayChannelBase payChannel : upiPayMethod
