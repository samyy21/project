...
import com.paytm.pgplus.upipsphandler.constants.TheiaConstant;
import com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtendedInfoKeys.PaymentStatusKeys;
import com.paytm.pgplus.upipsphandler.exception.TheiaServiceException;
import com.paytm.pgplus.upipsphandler.exception.SessionExpiredException;
import com.paytm.pgplus.upipsphandler.model.EnhanceCashierPageCachePayload;
import com.paytm.pgplus.upipsphandler.model.EnhancedCashierPage;
import com.paytm.pgplus.upipsphandler.model.MerchantInfo;
import com.paytm.pgplus.upipsphandler.model.UIMicroserviceResponse;
...
import com.paytm.pgplus.upipsphandler.service.ITheiaViewResolverService;
import com.paytm.pgplus.upipsphandler.utils.EnvInfoUtil;
import com.paytm.pgplus.upipsphandler.utils.EventUtils;
import com.paytm.pgplus.upipsphandler.utils.TransactionCacheUtils;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.FF4J.FEATURE_UI_MICROSERVICE_ENHANCED;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.FF4J.THEIA_VALIDATE_HEADER_WORKFLOW_ENABLE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.Native.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.ORDER_ID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.SUBSCRIPTION_ID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.TRANSACTION_ID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestTypes.*;
...
public class TransactionStatusServiceImpl {
    ...
    public Map<String, String> getCashierResponse(HttpServletRequest request) {
        ...
        try {
            ...
            if (transInfo.getRequestType() != null && isDynamicQRRequest(transInfo)) {
                ...
                CashierRequest.CashierRequestBuilder cashierRequestBuilder = new CashierRequest.CashierRequestBuilder(transId,
    ...
    private void processForOfflineProcessingPaymentStatus(GenericCoreResponseBean<DoPaymentResponse> cashierResponse,
        ...
        PaymentStatus paymentStatus = workFlowHelper.triggerCloseOrderPulses((com.paytm.pgplus.upipsphandler.model.WorkFlowTransactionBean) transactionBean);
        ...
        if ((ERequestType.UNI_PAY.name().equals(transInfo.getRequestType()) && isEnhancedNative)
            ...
            if (transInfo.getRequestType() != null
                ...
                boolean transactionStatusJsonRequest = Boolean.valueOf(request
                        .getParameter(TRANSACTION_STATUS_JSON_REQUEST));
    ...
    private void setPrnValidationStatus(HttpServletRequest request, CashierTransactionStatus cashierTransactionStatus,
        ...
        com.paytm.pgplus.upipsphandler.model.TransactionInfo transactionInfo = theiaSessionDataService
    ...
    private void generateResponseForNativeMerchantRedirect(GenericCoreResponseBean<DoPaymentResponse> cashierResponse,
        ...
        if (StringUtils.isBlank(callbackUrlBuilder)) {
            if (StringUtils.isBlank(txnToken)) {
                ...
                throw com.paytm.pgplus.upipsphandler.exception.offline.SessionExpiredException.getException();
            }
...
//    }
    ...
    private void setLooperRequest(String cashierRequestId, String transId, String alipayMerchantId,
                                  TransactionInfo transInfo, CashierRequest.CashierRequestBuilder cashierRequestBuilder) throws CashierCheckedException {
        if (transInfo != null) {
            switch (transInfo.getTransactionType()) {
                case FUND:
    ...
    public String generateRetryRequest(HttpServletRequest request, Map<String, String> data)
        ...
        retryRequest.append(ORDER_ID).append("=").append(orderId).append("&");
...
//    private void setOrderMetadata(TransactionInfo txnData,
...
//    }
    ...
    private void generateNativeEnhanceResponse(HttpServletRequest request,
        ...
        data.put(TheiaConstant.RetryConstants.IS_RETRY, RetryConstants.YES);
