...
import com.paytm.pgplus.upipsphandler.component.RetryPaymentInfoSessionUtil;
import com.paytm.pgplus.upipsphandler.component.RetryServiceHelper;
...
public class RetryPaymentServiceImpl implements IRetryPaymentService {
    ...
    public boolean processPaymentRequest(HttpServletRequest request, SavedCardRequest savedCardRequest)
        ...
        if (originalRequestData != null) {
            ...
            request.setAttribute(TheiaConstant.RequestParams.CHANNEL_ID,
