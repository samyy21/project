...
import com.paytm.pgplus.upipsphandler.component.PGPreferenceHelper;
...
import com.paytm.pgplus.upipsphandler.service.IMerchantUrlService;
                ...
                if (merchantUrlInfo != null) {
                    if (StringUtils.isBlank(request.getBody().getCallbackUrl())) {
                        ...
                        if (request.getBody().getExtendInfo() == null) {
                            request.getBody().setExtendInfo(new com.paytm.pgplus.models.ExtendInfo());
                        }
