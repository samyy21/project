...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtraConstants.THEIA_ENABLE_PROMOTIONS_IN_PCF;
...
public class NativeFetchPcfDetailsRequestProcessor
    ...
    private void validate(FetchPcfDetailRequest request) {
        ...
        if (!(isAddMoneyPcfEnabled(orderDetail.getMid(), request.getBody().getUserId())
            ...
            throw RequestValidationException.getException(com.paytm.pgplus.upipsphandler.enums.common.ResultCode.INVALID_MID);
        }
    ...
    private void enrich(FetchPcfDetailRequest request, String mid) {
        ...
        if ((merchantMappingResponse != null) && (merchantMappingResponse.getResponse() != null)) {
            ...
            throw RequestValidationException.getException(String.valueOf(ResultCode.INVALID_MID));
        }
    ...
    private void validateRequest(FetchPcfDetailRequest request) {
        if (request.getBody() == null || request.getHead() == null) {
            throw RequestValidationException.getException(com.paytm.pgplus.upipsphandler.enums.common.ResultCode.REQUEST_PARAMS_VALIDATION_EXCEPTION);
        }
